...
- [ ] Review SMTP and implement email queue
- [ ] Implement SMS service
- [ ] Implement SMS queue
- [ ] Implement built-in `/admin` dashboard
- [ ] Implement developer landing page after installation
- [ ] Implement `/dev/kanban`
- [ ] Review and optimize `assets/js/builder.js`
