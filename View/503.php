<div class="card-body p-5">
    ...
    <div class="d-flex justify-content-end mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="border-0" viewBox="0 0 465 285" role="img" aria-labelledby="title">
            <title id="title">Bob worried about the maintenance.</title>
            <defs>
            ...
            <g transform="translate(70,0)" filter="url(#drop)">
                ...
                <g transform="translate(0,180)" filter="url(#drop)">
                    <g class="bob">
                    ...
                    <g class="bubble">
                        ...
                        <path class="blink" transform="scale(2) translate(-8,-45)" fill="var(--bs-warning)" d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09z"/>
                    </g>
                </g>
            </g>
        </svg>
